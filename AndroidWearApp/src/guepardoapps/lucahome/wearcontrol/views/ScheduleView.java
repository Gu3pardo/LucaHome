...
import guepardoapps.lucahome.wearcontrol.views.customadapter.ScheduleListViewAdapter;
...
public class ScheduleView extends Activity {
	...
	private static final String COMMAND = "ACTION:GET:SCHEDULES";
	...
	private List<ScheduleListViewItem> _itemList = new ArrayList<>();
	...
	private BroadcastReceiver _updateReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			List<ScheduleListViewItem> itemList = (List<ScheduleListViewItem>) intent
					.getSerializableExtra(Constants.BUNDLE_SCHEDULE_LIST);
			if (itemList != null) {
				_itemList = itemList;
				_listAdapter = new ScheduleListViewAdapter(_context, _messageSendHelper, _itemList);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_itemList.add(new ScheduleListViewItem(R.drawable.circle_yellow, "Loading...", "", false));
	...
	protected void onResume() {
		...
		if (!_isInitialized) {
			_receiverController.RegisterReceiver(_updateReceiver,
					new String[] { Constants.BROADCAST_UPDATE_SCHEDULE_LIST });
