...
public class TemperatureListAdapter extends BaseAdapter {
	...
	private static String TAG = "TemperatureListAdapter";
	...
	private SerializableList<Temperature> _temperatureList;

	public TemperatureListAdapter(Context context, SerializableList<Temperature> temperatureList) {
